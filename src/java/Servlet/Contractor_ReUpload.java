 ...
 * @author Krist
 */
@WebServlet(name = "Contractor_ReUpload", urlPatterns = {"/Contractor_ReUpload"})
                ...
                try {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (!item.isFormField()) {
                            ...
                            path = new File("D:\\Development\\NetBeans\\Projects\\CogitoFinal\\Upload" + "/Bids and Awards Department" + "/Eligibility Documents/" + title + "/" + contractor.getName());
                    ...
                    Project project = contDAO.getProjectInfo(id);
                    Contractor_Has_Project contProject = contDAO.getContractorHasProject(project, contractor);
                    System.out.println("This is your contproject " + contProject.getContractor().getName());
                    
                    
                        Eligibility_Document document = new Eligibility_Document(0, fileName, "chrome-extension://ckccpjpbccmlnbpdgdnelhddmgbjhfab/" + "Bids and Awards Department" + "/Eligibility Documents/" + title + "/" + contractor.getName(), null, contProject, documentType, null, "");
