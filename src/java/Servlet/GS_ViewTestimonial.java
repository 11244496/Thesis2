 ...
 * @author RoAnn
 */
public class GS_ViewTestimonial extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Files> i = gs.getFiles(id, t, "Image");
            ArrayList<Files> v = gs.getFiles(id, t, "Video");
            ArrayList<Files> d = gs.getFiles(id, t, "Document");
