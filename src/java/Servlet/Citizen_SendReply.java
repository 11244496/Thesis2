 ...
 * @author RoAnn
 */
public class Citizen_SendReply extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            CitizenDAO gs = new CitizenDAO();
            Testimonial t = (Testimonial) session.getAttribute("openTestimonial");

            Citizen e = (Citizen) session.getAttribute("user");
            ...
            if (t.getCategory().equalsIgnoreCase("letter")) {
                dispatch = context.getRequestDispatcher("/Citizen_ViewLetter.jsp");
            } else {
